...
const timeline = [
  ...
  { year: "2023", text: "20-year anniversary — 300+ verified reviews, multi-city expansion readiness" },
  { year: "2026", text: "Continued commitment to operational excellence and premium positioning" },
];
    ...
    <section className="section-padding bg-secondary">
      <div className="max-w-4xl mx-auto">
        <ScrollReveal>
          ...
          <h2 className="font-display text-4xl md:text-5xl text-foreground text-center mb-16">Two Decades of Excellence</h2>
        </ScrollReveal>
      ...
      <div className="max-w-4xl mx-auto text-center">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground leading-[1.8] mb-12 max-w-2xl mx-auto">
            Salem Steamer was not built as a one-location operation. It was built on operational systems designed to scale responsibly — maintaining standards, certification alignment, and execution discipline across future service locations. Growth, for us, is not about expansion alone. It is about replicating excellence without dilution.
          </p>
